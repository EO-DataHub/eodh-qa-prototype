...
# description box
descr_box = dmc.Card(withBorder=True, shadow="xs", radius="md",
                     children=[html.H2('What is the CEOS Calibration Dashboard?',
                                       # style={'margin-top': '5vh',
                                       #      'margin-left': '75px',
                                       #      'margin-right': '75px'}
                                       ),
                               # html.P(
                                   html.Div(dcc.Markdown('''This dashboard displays the results from radiometric comparisons between a mission data \
                                      ...
                                      on the RadCalNet sites.''', link_target="_blank", style={"text-align": "justify"}),
                               # style={'margin-top': '5vh',
                               #        'margin-bottom': '75px',
                               #        'margin-left': '75px',
                               #        'margin-right': '75px'}
...
# how-to box
how_to_box = dmc.Card(withBorder=True, shadow="xs", radius="md",
                       children=[html.H2('How to navigate the dashboard:',
                              # style={'margin-top': '5vh',
                              #        'margin-left': '75px',
                              #        'margin-right': '75px'}
                                         ),
...
# EODH descr box
eodh_card =dmc.Card(withBorder=True, shadow="xs", radius="md",
                    children=[
                        dbc.CardImg(src='assets/powered_by_eodh.png', top=True, style={"width": "25rem", 'margin-bottom': '20px'}),
                        dbc.CardBody(
                            html.Div(dcc.Markdown(''' The EODH can be accessed at: [staging.eodatahub.org.uk]("https://staging.eodatahub.org.uk/").  
                            ...
                            The EODH STAC catalog entry for the data collection selected on the CEOS Dashboard can be accessed at the link provided. 
                                                    ''', link_target="_blank", style={"text-align": "justify"}), className="card-text")
                        ),
                    ],
                    # style={"width": "25rem"},
)
    ...
    dbc.Row(
        dbc.Col(dmc.Container(fluid=True, children=[
            dbc.Row(children=[
                ...
                dbc.Col(how_to_box,  # xs=2, sm=2, md=2, lg=2,
